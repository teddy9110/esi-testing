...
if (!isset($_GET['code'])) {
    ...
    $options = [
        'scope' => ['publicData','esi-corporations.read_structures.v1','esi-contracts.read_corporation_contracts.v1' ] // array or string
    ];
...
// Check given state against previously stored one to mitigate CSRF attack
  ...
  $request = $provider->getAuthenticatedRequest(
   ...
   $_SESSION['token']->getToken()
    ...
    $request = $provider->getAuthenticatedRequest(
        'GET',
        'https://esi.evetech.net/v1/corporations/98562176/contracts/',
       $_SESSION['token']->getToken()
        );
